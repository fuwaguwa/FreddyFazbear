...
@ApplyOptions<SubcommandOptions>({
  ...
  subcommands: [
    ...
    { name: "random", chatInputRun: "subcommandRandom" },
    {
      ...
      type: "group",
      entries: [
        { name: "hoyo", chatInputRun: "subcommandPremium" },
        { name: "kemonomimi", chatInputRun: "subcommandPremium" },
        { name: "shipgirls", chatInputRun: "subcommandPremium" },
        { name: "undies", chatInputRun: "subcommandPremium" },
        { name: "misc", chatInputRun: "subcommandPremium" },
        { name: "random", chatInputRun: "subcommandPremiumRandom" },
      ],
    },
  ],
})
